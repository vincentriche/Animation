...
int Viewer::render()
{
	...
	if (key_state(SDLK_UP) && key_state(SDLK_m)) { MousePos = MousePos + Vector(0, step_i, 0); }
	if (key_state(SDLK_DOWN) && key_state(SDLK_m)) { MousePos = MousePos + Vector(0, -step_i, 0); }
	if (key_state(SDLK_PAGEUP) && key_state(SDLK_m)) { MousePos = MousePos + Vector(0, 0, -step_i); }
	if (key_state(SDLK_PAGEDOWN) && key_state(SDLK_m)) { MousePos = MousePos + Vector(0, 0, step_i); }
